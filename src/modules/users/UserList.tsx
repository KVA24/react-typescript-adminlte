...
class UserList extends Component {
    ...
    async componentDidMount() {
		...
		this.setState({isUserAccess: window.location.pathname.includes('user-access')})
		if(window.location.pathname.includes('user-access')) {
			await userStore.getUsersAccess()
		} else {
        ...
        return (
            <div className="user_list">
                <div className="content-wrapper">
                    ...
                    <DeleteUser/>
                    <EditUser/>
                    <AddUser isUserAccess={this.state.isUserAccess}/>
                </div>
            </div>
        );
    }
